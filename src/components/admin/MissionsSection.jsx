...
const getStatusColor = (status) => {
  switch (status) {
    case "Programada": return "text-blue-400";
                ...
                <Card className="h-full flex flex-col glassmorphic hover:shadow-primary/20">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      ...
                      <div className={`flex items-center text-xs font-semibold px-2 py-1 rounded-full ${getStatusColor(mission.status)} bg-secondary`}>
                  ...
                  <CardContent className="flex-grow">
                    <p className="text-foreground whitespace-pre-wrap break-words line-clamp-4">{mission.description}</p>
                  </CardContent>

...
const VideosSection = () => {
  const videos = [
    { id: "7KRR1VFznaw", title: "Drone Ucraniano em Ação" }, // Substitua pelo ID real
    { id: "cn4zIHtOLiE", title: "SQUAD - Highlights" }, // Substitua pelo ID real
    { id: "2LgF3l9Vs8k", title: "Squad - Batalha em Fallujah" }, // Substitua pelo ID real
  ];
      ...
      {youtubeChannelUrl && (
        ...
        >
          <Button 
            variant="outline" 
            size="lg" 
            className="text-highlight-vibrant border-highlight-vibrant hover:bg-highlight-vibrant hover:text-background transition-all duration-300 transform hover:scale-105 py-3 px-6 md:py-4 md:px-8 text-base md:text-lg shadow-md hover:shadow-lg hover:shadow-highlight-vibrant/30"

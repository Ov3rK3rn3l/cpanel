          ...
          <Card className="glassmorphic h-full border border-primary/30">
            ...
            <CardContent className="h-[350px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={stats.patenteDistribution} cx="50%" cy="50%" innerRadius="50%" outerRadius="80%" fill="#8884d8" dataKey="value" nameKey="name" paddingAngle={2}>
            ...
            <CardContent className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={stats.memberFlow} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
                  ...
                  <Bar dataKey="new" name="Novos Membros" fill="#82ca9d" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="left" name="Desligamentos" fill="#ff7300" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
        ...
        <motion.div variants={cardVariants} custom={8} initial="hidden" animate="visible">
          <Card className="glassmorphic h-full border border-primary/30">
            ...
            <CardContent className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={stats.missionStatus} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius="80%" fill="#8884d8" labelLine={false} label={({ name, percent }) => `${name} (${(percent * 100).toFixed(0)}%)`}>
          ...
          <CardContent className="h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart layout="vertical" data={stats.warningDistribution} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                ...
                <Tooltip content={<CustomTooltip />} />
                <Bar dataKey="value" name="Quantidade" fill="#8884d8" radius={[0, 4, 4, 0]} barSize={25}>

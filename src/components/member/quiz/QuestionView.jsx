...
const COINS_PER_PATENTE_GROUP = {
  DEFAULT: 2, RESERVISTA: 5, RECRUTA: 8, SOLDADO: 10, CABO: 15,
  SARGENTO_BAIXO: 25, SARGENTO_MEDIO: 27, SARGENTO_ALTO: 29, SUBTENENTE: 35,
  OFICIAL_ALUNO_ASPIRANTE: 50, TENENTE_BAIXO: 60, TENENTE_ALTO: 65, CAPITAO: 80,
};

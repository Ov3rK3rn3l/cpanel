...
import { Info, Loader2, ShieldCheck, CalendarDays, ShieldAlert, Coins, Menu, Award } from 'lucide-react';
    ...
    if (memberData) {
      ...
      if (currentPresences >= 120 && memberData.cfo !== YES_NO_OPTIONS_VALUES.SIM) {
        alertMsg = {
         ...
         alertMsg = {
          type: "esa",
          text: "🎯 Atenção, Soldado! Para alcançar 3º Sargento, você precisa concluir o curso ESA. Fale com um oficial!"
        };
      }
      ...
      >
        <div className="mb-10 text-center">
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary-light to-accent mb-3"
          >
